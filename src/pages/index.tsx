  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Introducing HR Management Application - Your Gateway to Seamless Human Resource Management. Unleash Your Potential with Efficient Workflows."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Introducing HR Management Application - Your Gateway to Seamless Human Resource Management. Unleash Your Potential with Efficient Workflows.`}
            </Text>
            <Box
