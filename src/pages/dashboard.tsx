...
import { getSalaryStructures } from 'apiSdk/salary-structures';
...
function DashboardPage() {
  ...
  const salaryStructureStat = useSWR<PaginatedInterface<SalaryStructureInterface>>(
    () => `/salary-structures`,
    () => getSalaryStructures({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: salaryStructureStat?.data?.totalCount,
      isLoading: salaryStructureStat.isLoading,
